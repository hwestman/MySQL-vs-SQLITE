...
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty one%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty two%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty three%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty four%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty five%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty six%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty seven%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty eight%';
SELECT count(*), avg(b) FROM t2 WHERE c LIKE '%fourty nine%';
